component accessors="true" hint="A CFML binding for Selenium" {
	...
	*/
	...
	public any function init (string host = "localhost", numeric port = 4444,
		numeric executionDelay = 200, string seleniumJarPath = "/cfselenium/Selenium-RC/selenium-server-standalone-2.16.0.jar", boolean verbose = false, string seleniumServerArguments = "",
